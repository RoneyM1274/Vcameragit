...
public final class DotsIndicator extends BaseDotsIndicator {
    ...
    private final void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attrs, com.tbuonomo.viewpagerdotsindicator.R.styleable.DotsIndicator);
            Intrinsics.checkNotNullExpressionValue(typedArrayObtainStyledAttributes, "context.obtainStyledAttr….styleable.DotsIndicator)");
            setSelectedDotColor(typedArrayObtainStyledAttributes.getColor(com.tbuonomo.viewpagerdotsindicator.R.styleable.DotsIndicator_selectedDotColor, BaseDotsIndicator.DEFAULT_POINT_COLOR));
            float f = typedArrayObtainStyledAttributes.getFloat(com.tbuonomo.viewpagerdotsindicator.R.styleable.DotsIndicator_dotsWidthFactor, 2.5f);
            this.dotsWidthFactor = f;
            if (f < 1) {
                this.dotsWidthFactor = 2.5f;
            }
            this.progressMode = typedArrayObtainStyledAttributes.getBoolean(com.tbuonomo.viewpagerdotsindicator.R.styleable.DotsIndicator_progressMode, false);
            this.dotsElevation = typedArrayObtainStyledAttributes.getDimension(com.tbuonomo.viewpagerdotsindicator.R.styleable.DotsIndicator_dotsElevation, 0.0f);
    ...
    public void addDot(final int index) {
        View dot = LayoutInflater.from(getContext()).inflate(com.tbuonomo.viewpagerdotsindicator.R.layout.dot_layout, (ViewGroup) this, false);
        ImageView imageView = (ImageView) dot.findViewById(com.tbuonomo.viewpagerdotsindicator.R.id.dot);
        ...
        dot.setOnClickListener(new OnClickListener() { // from class: com.tbuonomo.viewpagerdotsindicator.DotsIndicator.addDot.1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                if (DotsIndicator.this.getDotsClickable()) {
                    int i = index;
                    Pager pager2 = DotsIndicator.this.getPager();
                    if (i < (pager2 != null ? pager2.getCount() : 0)) {
                        Pager pager3 = DotsIndicator.this.getPager();
                ...
                if (dotsIndicator.isInBounds(dotsIndicator.dots, nextPosition)) {
                    ...
                    if (DotsIndicator.this.getSelectedDotColor() != DotsIndicator.this.getDotsColor()) {
                        ...
                        if (DotsIndicator.this.progressMode) {
                            Pager pager = DotsIndicator.this.getPager();
                            Intrinsics.checkNotNull(pager);
