...
public abstract class BaseDotsIndicator extends FrameLayout {
    ...
    public interface Pager {
        void addOnPageChangeListener(com.tbuonomo.viewpagerdotsindicator.OnPageChangeListenerHelper onPageChangeListenerHelper);
    ...
    public abstract com.tbuonomo.viewpagerdotsindicator.OnPageChangeListenerHelper buildOnPageChangedListener();
    ...
    public static final class Type {
        ...
        static {
            int[] iArr = com.tbuonomo.viewpagerdotsindicator.R.styleable.SpringDotsIndicator;
            Intrinsics.checkNotNullExpressionValue(iArr, "R.styleable.SpringDotsIndicator");
            Type type = new Type("DEFAULT", 0, 16.0f, 8.0f, iArr, com.tbuonomo.viewpagerdotsindicator.R.styleable.SpringDotsIndicator_dotsColor, com.tbuonomo.viewpagerdotsindicator.R.styleable.SpringDotsIndicator_dotsSize, com.tbuonomo.viewpagerdotsindicator.R.styleable.SpringDotsIndicator_dotsSpacing, com.tbuonomo.viewpagerdotsindicator.R.styleable.SpringDotsIndicator_dotsCornerRadius, com.tbuonomo.viewpagerdotsindicator.R.styleable.SpringDotsIndicator_dotsClickable);
            DEFAULT = type;
            int[] iArr2 = com.tbuonomo.viewpagerdotsindicator.R.styleable.DotsIndicator;
            Intrinsics.checkNotNullExpressionValue(iArr2, "R.styleable.DotsIndicator");
            Type type2 = new Type("SPRING", 1, 16.0f, 4.0f, iArr2, com.tbuonomo.viewpagerdotsindicator.R.styleable.DotsIndicator_dotsColor, com.tbuonomo.viewpagerdotsindicator.R.styleable.DotsIndicator_dotsSize, com.tbuonomo.viewpagerdotsindicator.R.styleable.DotsIndicator_dotsSpacing, com.tbuonomo.viewpagerdotsindicator.R.styleable.DotsIndicator_dotsCornerRadius, com.tbuonomo.viewpagerdotsindicator.R.styleable.SpringDotsIndicator_dotsClickable);
            SPRING = type2;
            int[] iArr3 = com.tbuonomo.viewpagerdotsindicator.R.styleable.WormDotsIndicator;
            Intrinsics.checkNotNullExpressionValue(iArr3, "R.styleable.WormDotsIndicator");
            Type type3 = new Type("WORM", 2, 16.0f, 4.0f, iArr3, com.tbuonomo.viewpagerdotsindicator.R.styleable.WormDotsIndicator_dotsColor, com.tbuonomo.viewpagerdotsindicator.R.styleable.WormDotsIndicator_dotsSize, com.tbuonomo.viewpagerdotsindicator.R.styleable.WormDotsIndicator_dotsSpacing, com.tbuonomo.viewpagerdotsindicator.R.styleable.WormDotsIndicator_dotsCornerRadius, com.tbuonomo.viewpagerdotsindicator.R.styleable.SpringDotsIndicator_dotsClickable);
            WORM = type3;
    ...
    public final void refreshOnPageChangedListener() {
        ...
        if (pager.isNotEmpty()) {
            ...
            com.tbuonomo.viewpagerdotsindicator.OnPageChangeListenerHelper onPageChangeListenerHelperBuildOnPageChangedListener = buildOnPageChangedListener();
            Pager pager3 = this.pager;
            Intrinsics.checkNotNull(pager3);
    ...
    public final void setViewPager(final ViewPager viewPager) {
        ...
        this.pager = new Pager() { // from class: com.tbuonomo.viewpagerdotsindicator.BaseDotsIndicator.setViewPager.2
            ...
            @Override // com.tbuonomo.viewpagerdotsindicator.BaseDotsIndicator.Pager
            public void addOnPageChangeListener(final com.tbuonomo.viewpagerdotsindicator.OnPageChangeListenerHelper onPageChangeListenerHelper) {
    ...
    public final int getThemePrimaryColor(Context getThemePrimaryColor) {
        ...
        getThemePrimaryColor.getTheme().resolveAttribute(com.tbuonomo.viewpagerdotsindicator.R.attr.colorPrimary, typedValue, true);
