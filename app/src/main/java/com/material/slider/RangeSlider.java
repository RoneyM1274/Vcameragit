...
public class RangeSlider extends com.google.android.material.slider.BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    static class RangeSliderState extends AbsSavedState {
        public static final Creator<RangeSliderState> CREATOR = new Creator<RangeSliderState>() { // from class: com.google.android.material.slider.RangeSlider.RangeSliderState.1
