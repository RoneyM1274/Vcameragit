...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        super.addView(slidingTabIndicator, 0, new LayoutParams(-2, -1));
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode != Integer.MIN_VALUE) {
            if (mode == 0) {
                i2 = MeasureSpec.makeMeasureSpec(iRound + getPaddingTop() + getPaddingBottom(), BasicMeasure.EXACTLY);
            }
        } else if (getChildCount() == 1 && MeasureSpec.getSize(i2) >= iRound) {
        ...
        if (getChildCount() == 1) {
            ...
            if (z) {
                childAt.measure(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), BasicMeasure.EXACTLY), getChildMeasureSpec(i2, getPaddingTop() + getPaddingBottom(), childAt.getLayoutParams().height));
            }
        }
    }
    ...
    public final class TabView extends LinearLayout {
        ...
        private void addOnLayoutChangeListener(final View view) {
            ...
            view.addOnLayoutChangeListener(new OnLayoutChangeListener() { // from class: com.google.android.material.tabs.TabLayout.TabView.1
