...
class TabIndicatorInterpolator {
    ...
    static RectF calculateTabViewContentBounds(com.google.android.material.tabs.TabLayout.TabView tabView, int i) {
    ...
    static RectF calculateIndicatorWidthForTab(com.google.android.material.tabs.TabLayout tabLayout, View view) {
        if (view == null) {
            return new RectF();
        }
    ...
    void setIndicatorBoundsForTab(com.google.android.material.tabs.TabLayout tabLayout, View view, Drawable drawable) {
