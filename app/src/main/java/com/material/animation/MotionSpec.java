package com.material.animation;
...
public class MotionSpec {
    ...
    private final SimpleArrayMap<String, com.google.android.material.animation.MotionTiming> timings = new SimpleArrayMap<>();
    ...
    public com.google.android.material.animation.MotionTiming getTiming(String str) {
        if (!hasTiming(str)) {
    ...
    public void setTiming(String str, com.google.android.material.animation.MotionTiming motionTiming) {
