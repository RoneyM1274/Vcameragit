...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public static <T> MaterialCalendar<T> newInstance(com.google.android.material.datepicker.DateSelector<T> dateSelector, int i, com.google.android.material.datepicker.CalendarConstraints calendarConstraints) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        gridView.setAdapter((ListAdapter) new com.google.android.material.datepicker.DaysOfWeekAdapter());
        ...
        com.google.android.material.datepicker.MonthsPagerAdapter monthsPagerAdapter = new com.google.android.material.datepicker.MonthsPagerAdapter(contextThemeWrapper, this.dateSelector, this.calendarConstraints, new OnDayClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.3
            ...
            public void onDayClick(long j) {
                if (MaterialCalendar.this.calendarConstraints.getDateValidator().isValid(j)) {
                    ...
                    Iterator<com.google.android.material.datepicker.OnSelectionChangedListener<S>> it = MaterialCalendar.this.onSelectionChangedListeners.iterator();
                    while (it.hasNext()) {
    ...
    private RecyclerView.ItemDecoration createItemDecoration() {
        return new RecyclerView.ItemDecoration() { // from class: com.google.android.material.datepicker.MaterialCalendar.4
            private final Calendar startItem = com.google.android.material.datepicker.UtcDates.getUtcCalendar();
            private final Calendar endItem = com.google.android.material.datepicker.UtcDates.getUtcCalendar();

            @Override // androidx.recyclerview.widget.RecyclerView.ItemDecoration
            public void onDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
                int width;
                if ((recyclerView.getAdapter() instanceof com.google.android.material.datepicker.YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
    ...
    private void addActionsToMonthNavigation(View view, final com.google.android.material.datepicker.MonthsPagerAdapter monthsPagerAdapter) {
