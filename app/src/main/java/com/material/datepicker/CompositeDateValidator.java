...
public final class CompositeDateValidator implements CalendarConstraints.DateValidator {
    ...
    public static final Creator<CompositeDateValidator> CREATOR = new Creator<CompositeDateValidator>() { // from class: com.google.android.material.datepicker.CompositeDateValidator.3
