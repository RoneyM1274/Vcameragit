...
public class SingleDateSelector implements DateSelector<Long> {
    public static final Creator<SingleDateSelector> CREATOR = new Creator<SingleDateSelector>() { // from class: com.google.android.material.datepicker.SingleDateSelector.2
    ...
    public void setSelection(Long l) {
        this.selectedItem = l == null ? null : Long.valueOf(com.google.android.material.datepicker.UtcDates.canonicalYearMonthDay(l.longValue()));
    }
