...
final class Month implements Comparable<Month>, Parcelable {
    public static final Creator<Month> CREATOR = new Creator<Month>() { // from class: com.google.android.material.datepicker.Month.1
    ...
    private Month(Calendar calendar) {
        calendar.set(5, 1);
        Calendar dayCopy = com.google.android.material.datepicker.UtcDates.getDayCopy(calendar);
    ...
    static Month current() {
        return new Month(com.google.android.material.datepicker.UtcDates.getTodayCalendar());
    }
    ...
    long getDay(int i) {
        Calendar dayCopy = com.google.android.material.datepicker.UtcDates.getDayCopy(this.firstOfMonth);
        dayCopy.set(5, i);
