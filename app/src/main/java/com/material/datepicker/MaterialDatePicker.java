...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public static final class Builder<S> {
        ...
        public Builder<S> setCalendarConstraints(com.google.android.material.datepicker.CalendarConstraints calendarConstraints) {
        ...
        private com.google.android.material.datepicker.Month createDefaultOpenAt() {
            ...
            if (!this.dateSelector.getSelectedDays().isEmpty()) {
                ...
                if (jLongValue >= j && jLongValue <= j2) {
                    return com.google.android.material.datepicker.Month.create(jLongValue);
                }
            }
