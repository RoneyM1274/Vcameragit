package com.material.timepicker;
...
public final class MaterialTimePicker extends DialogFragment {
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        com.google.android.material.timepicker.TimePickerView timePickerView = (com.google.android.material.timepicker.TimePickerView) viewGroup2.findViewById(R.id.material_timepicker_view);
        this.timePickerView = timePickerView;
        timePickerView.setOnDoubleTapListener(new com.google.android.material.timepicker.TimePickerView.OnDoubleTapListener() { // from class: com.google.android.material.timepicker.MaterialTimePicker.1
    ...
    public void updateInputMode(MaterialButton materialButton) {
        ...
        com.google.android.material.timepicker.TimePickerPresenter timePickerPresenterInitializeOrRetrieveActivePresenterForMode = initializeOrRetrieveActivePresenterForMode(this.inputMode);
    ...
    private com.google.android.material.timepicker.TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int i) {
        ...
        if (this.timePickerTextInputPresenter == null) {
            ...
            this.timePickerTextInputPresenter = new com.google.android.material.timepicker.TimePickerTextInputPresenter(this.textInputView, this.time);
        }
