...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.selectionListener = new OnClickListener() { // from class: com.google.android.material.timepicker.TimePickerView.1
    ...
    private void setupDoubleTap() {
        ...
        OnTouchListener onTouchListener = new OnTouchListener() { // from class: com.google.android.material.timepicker.TimePickerView.4
