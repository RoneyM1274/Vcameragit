...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View view, int i, ShapeAppearanceModel shapeAppearanceModel) {
        ...
        RectF relativeBounds = view3.getParent() == null ? com.google.android.material.transition.TransitionUtils.getRelativeBounds(view3) : com.google.android.material.transition.TransitionUtils.getLocationOnScreen(view3);
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF == null || shapeAppearanceModel == null) {
                ...
                if (this.drawingViewId == view3.getId()) {
                    ...
                    viewFindAncestorById = com.google.android.material.transition.TransitionUtils.findAncestorById(view3, this.drawingViewId);
                    view3 = null;
                }
                RectF locationOnScreen = com.google.android.material.transition.TransitionUtils.getLocationOnScreen(viewFindAncestorById);
    ...
    private static RectF calculateDrawableBounds(View view, View view2, float f, float f2) {
        if (view2 != null) {
            RectF locationOnScreen = com.google.android.material.transition.TransitionUtils.getLocationOnScreen(view2);
    ...
    private ProgressThresholdsGroup getThresholdsOrDefault(boolean z, ProgressThresholdsGroup progressThresholdsGroup, ProgressThresholdsGroup progressThresholdsGroup2) {
        ...
        return new ProgressThresholdsGroup((ProgressThresholds) com.google.android.material.transition.TransitionUtils.defaultIfNull(this.fadeProgressThresholds, progressThresholdsGroup.fade), (ProgressThresholds) com.google.android.material.transition.TransitionUtils.defaultIfNull(this.scaleProgressThresholds, progressThresholdsGroup.scale), (ProgressThresholds) com.google.android.material.transition.TransitionUtils.defaultIfNull(this.scaleMaskProgressThresholds, progressThresholdsGroup.scaleMask), (ProgressThresholds) com.google.android.material.transition.TransitionUtils.defaultIfNull(this.shapeMaskProgressThresholds, progressThresholdsGroup.shapeMask));
    }
