...
abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    void setInternalAnimationCallback(AnimationCallback animationCallback) {
        this.internalAnimationCallback = animationCallback;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void dispatchAnimationStart() {
        AnimationCallback animationCallback = this.internalAnimationCallback;
        ...
        Iterator<AnimationCallback> it = list.iterator();
        while (it.hasNext()) {
