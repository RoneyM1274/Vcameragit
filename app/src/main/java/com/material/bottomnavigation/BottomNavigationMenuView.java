package com.material.bottomnavigation;
...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    private final SparseArray<OnTouchListener> onTouchListeners;
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.onClickListener = new OnClickListener() { // from class: com.google.android.material.bottomnavigation.BottomNavigationMenuView.1
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iMakeMeasureSpec = MeasureSpec.makeMeasureSpec(this.itemHeight, BasicMeasure.EXACTLY);
        if (isShifting(this.labelVisibilityMode, size2) && this.itemHorizontalTranslationEnabled) {
            ...
            if (childAt.getVisibility() != 8) {
                childAt.measure(MeasureSpec.makeMeasureSpec(this.activeItemMaxWidth, Integer.MIN_VALUE), iMakeMeasureSpec);
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(MeasureSpec.makeMeasureSpec(this.tempChildWidths[i9], BasicMeasure.EXACTLY), iMakeMeasureSpec);
                childAt2.getLayoutParams().width = childAt2.getMeasuredWidth();
                measuredWidth += childAt2.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(measuredWidth, MeasureSpec.makeMeasureSpec(measuredWidth, BasicMeasure.EXACTLY), 0), View.resolveSizeAndState(this.itemHeight, iMakeMeasureSpec, 0));
    }
    ...
    public void setItemOnTouchListener(int i, OnTouchListener onTouchListener) {
