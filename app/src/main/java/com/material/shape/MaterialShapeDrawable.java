...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    private MaterialShapeDrawable(MaterialShapeDrawableState materialShapeDrawableState) {
        ...
        this.pathProvider = Looper.getMainLooper().getThread() == Thread.currentThread() ? com.google.android.material.shape.ShapeAppearancePathProvider.getInstance() : new com.google.android.material.shape.ShapeAppearancePathProvider();
    ...
    private void drawShape(Canvas canvas, Paint paint, Path path, com.google.android.material.shape.ShapeAppearanceModel shapeAppearanceModel, RectF rectF) {
