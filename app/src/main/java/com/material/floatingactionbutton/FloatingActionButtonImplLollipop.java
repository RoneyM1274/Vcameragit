...
class FloatingActionButtonImplLollipop extends com.google.android.material.floatingactionbutton.FloatingActionButtonImpl {
    ...
    FloatingActionButtonImplLollipop(com.google.android.material.floatingactionbutton.FloatingActionButton floatingActionButton, ShadowViewDelegate shadowViewDelegate) {
    ...
    void onElevationsChanged(float f, float f2, float f3) {
        if (Build.VERSION.SDK_INT == 21) {
            ...
            if (Build.VERSION.SDK_INT >= 22 && Build.VERSION.SDK_INT <= 24) {
                arrayList.add(ObjectAnimator.ofFloat(this.view, (Property<com.google.android.material.floatingactionbutton.FloatingActionButton, Float>) View.TRANSLATION_Z, this.view.getTranslationZ()).setDuration(100L));
            }
            arrayList.add(ObjectAnimator.ofFloat(this.view, (Property<com.google.android.material.floatingactionbutton.FloatingActionButton, Float>) View.TRANSLATION_Z, 0.0f).setDuration(100L));
