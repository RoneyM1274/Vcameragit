package com.material.floatingactionbutton;
...
abstract class BaseMotionStrategy implements com.google.android.material.floatingactionbutton.MotionStrategy {
    ...
    BaseMotionStrategy(com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton extendedFloatingActionButton, AnimatorTracker animatorTracker) {
    ...
    AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues("labelOpacity")) {
            arrayList.add(motionSpec.getAnimator("labelOpacity", this.fab, new Property<com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton, Float>(Float.class, "LABEL_OPACITY_PROPERTY") { // from class: com.google.android.material.floatingactionbutton.BaseMotionStrategy.1
                @Override // android.util.Property
                public Float get(com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton extendedFloatingActionButton) {
