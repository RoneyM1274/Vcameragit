...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    public MaterialButton(Context context, AttributeSet attributeSet, int i) {
        ...
        com.google.android.material.button.MaterialButtonHelper materialButtonHelper = new com.google.android.material.button.MaterialButtonHelper(this, ShapeAppearanceModel.builder(context2, attributeSet, i, i2).build());
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new ClassLoaderCreator<SavedState>() { // from class: com.google.android.material.button.MaterialButton.SavedState.1
