...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    private void adjustChildMarginsAndUpdateLayout() {
        ...
        for (int i = firstVisibleChildIndex + 1; i < getChildCount(); i++) {
            ...
            LayoutParams layoutParamsBuildLayoutParams = buildLayoutParams(childButton);
            if (getOrientation() == 0) {
    ...
    private void resetChildMargins(int i) {
        ...
        LayoutParams layoutParams = (LayoutParams) getChildButton(i).getLayoutParams();
        if (getOrientation() == 1) {
    ...
    private LayoutParams buildLayoutParams(View view) {
