...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x010c: INVOKE (r21v0 'canvas' android.graphics.Canvas), (r15v0 'f5' float), (r6v1 float) VIRTUAL call: android.graphics.Canvas.scale(float, float):void A[MD:(float, float):void (c)] (LINE:274) in method: com.google.android.material.shadow.ShadowDrawableWrapper.drawShadow(android.graphics.Canvas):void, file: classes.dex
