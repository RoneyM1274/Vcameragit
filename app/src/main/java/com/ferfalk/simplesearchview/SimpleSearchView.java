...
public final class SimpleSearchView extends FrameLayout {
    ...
    private final void initStyle(AttributeSet attrs, int defStyleAttr) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attrs, R.styleable.SimpleSearchView, defStyleAttr, 0);
        Intrinsics.checkNotNullExpressionValue(typedArrayObtainStyledAttributes, "context.obtainStyledAttr…rchView, defStyleAttr, 0)");
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_type)) {
            setCardStyle(typedArrayObtainStyledAttributes.getInt(R.styleable.SimpleSearchView_type, this.style));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_backIconAlpha)) {
            setBackIconAlpha(typedArrayObtainStyledAttributes.getFloat(R.styleable.SimpleSearchView_backIconAlpha, BACK_ICON_ALPHA_DEFAULT));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_iconsAlpha)) {
            setIconsAlpha(typedArrayObtainStyledAttributes.getFloat(R.styleable.SimpleSearchView_iconsAlpha, 0.54f));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_backIconTint)) {
            int i = R.styleable.SimpleSearchView_backIconTint;
            Context context = getContext();
            Intrinsics.checkNotNullExpressionValue(context, "context");
            setBackIconColor(typedArrayObtainStyledAttributes.getColor(i, ContextUtils.getPrimaryColor(context)));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_iconsTint)) {
            setIconsColor(typedArrayObtainStyledAttributes.getColor(R.styleable.SimpleSearchView_iconsTint, ViewCompat.MEASURED_STATE_MASK));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_cursorColor)) {
            int i2 = R.styleable.SimpleSearchView_cursorColor;
            Context context2 = getContext();
            Intrinsics.checkNotNullExpressionValue(context2, "context");
            setCursorColor(typedArrayObtainStyledAttributes.getColor(i2, ContextUtils.getAccentColor(context2)));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_hintColor)) {
            setHintTextColor(typedArrayObtainStyledAttributes.getColor(R.styleable.SimpleSearchView_hintColor, ContextCompat.getColor(getContext(), R.color.default_textColorHint)));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_searchBackground)) {
            setSearchBackground(typedArrayObtainStyledAttributes.getDrawable(R.styleable.SimpleSearchView_searchBackground));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_searchBackIcon)) {
            setBackIconDrawable(typedArrayObtainStyledAttributes.getDrawable(R.styleable.SimpleSearchView_searchBackIcon));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_searchClearIcon)) {
            setClearIconDrawable(typedArrayObtainStyledAttributes.getDrawable(R.styleable.SimpleSearchView_searchClearIcon));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_searchVoiceIcon)) {
            setVoiceIconDrawable(typedArrayObtainStyledAttributes.getDrawable(R.styleable.SimpleSearchView_searchVoiceIcon));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_voiceSearch)) {
            enableVoiceSearch(typedArrayObtainStyledAttributes.getBoolean(R.styleable.SimpleSearchView_voiceSearch, this.allowVoiceSearch));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_voiceSearchPrompt)) {
            setVoiceSearchPrompt(typedArrayObtainStyledAttributes.getString(R.styleable.SimpleSearchView_voiceSearchPrompt));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_android_hint)) {
            setHint(typedArrayObtainStyledAttributes.getString(R.styleable.SimpleSearchView_android_hint));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_android_inputType)) {
            setInputType(typedArrayObtainStyledAttributes.getInt(R.styleable.SimpleSearchView_android_inputType, 524288));
        }
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.SimpleSearchView_android_textColor)) {
            setTextColor(typedArrayObtainStyledAttributes.getColor(R.styleable.SimpleSearchView_android_textColor, ContextCompat.getColor(getContext(), R.color.default_textColor)));
        }
        ...
        if (animate) {
            SimpleAnimationUtils.revealOrFadeIn(this, this.animationDuration, new SimpleAnimationListener() { // from class: com.ferfalk.simplesearchview.SimpleSearchView$showSearch$$inlined$with$lambda$1
                ...
                public boolean onAnimationEnd(View view) {
                    ...
                    SimpleSearchView.SearchViewListener searchViewListener = this.this$0.searchViewListener;
    ...
    public static final class SavedState extends View.BaseSavedState {
        ...
        private static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: com.ferfalk.simplesearchview.SimpleSearchView$SavedState$Companion$CREATOR$1
            ...
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public SimpleSearchView.SavedState[] newArray(int size) {
                return new SimpleSearchView.SavedState[size];
            }
        };
