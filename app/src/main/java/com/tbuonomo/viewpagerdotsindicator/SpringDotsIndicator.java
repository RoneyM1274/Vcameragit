...
public final class SpringDotsIndicator extends BaseDotsIndicator {
    ...
    public void addDot(final int index) {
        ...
        viewGroupBuildDot.setOnClickListener(new View.OnClickListener() { // from class: com.tbuonomo.viewpagerdotsindicator.SpringDotsIndicator.addDot.1
    ...
    private final void setUpDotBackground(boolean stroke, View dotView) {
        View viewFindViewById = dotView.findViewById(R.id.spring_dot);
