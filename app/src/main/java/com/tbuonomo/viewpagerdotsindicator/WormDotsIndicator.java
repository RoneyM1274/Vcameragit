...
public final class WormDotsIndicator extends BaseDotsIndicator {
    ...
    public WormDotsIndicator(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            this.dotsStrokeWidth = (int) typedArrayObtainStyledAttributes.getDimension(R.styleable.WormDotsIndicator_dotsStrokeWidth, this.dotsStrokeWidth);
    ...
    public void addDot(final int index) {
        ...
        viewGroupBuildDot.setOnClickListener(new View.OnClickListener() { // from class: com.tbuonomo.viewpagerdotsindicator.WormDotsIndicator.addDot.1
