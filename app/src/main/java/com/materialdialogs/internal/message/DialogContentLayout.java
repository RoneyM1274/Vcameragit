package com.materialdialogs.internal.message;
...
public final class DialogContentLayout extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (dialogScrollView != null) {
            dialogScrollView.measure(MeasureSpec.makeMeasureSpec(size, BasicMeasure.EXACTLY), MeasureSpec.makeMeasureSpec(size2, Integer.MIN_VALUE));
        }
        ...
        for (int i3 = 0; i3 < childCount2; i3++) {
            ...
            if (dialogScrollView3 == null || id != dialogScrollView3.getId()) {
                if (Intrinsics.areEqual(currentChild, this.customView) && this.useHorizontalPadding) {
                    iMakeMeasureSpec = MeasureSpec.makeMeasureSpec(size - (getFrameHorizontalMargin() * 2), BasicMeasure.EXACTLY);
                } else {
                    iMakeMeasureSpec = MeasureSpec.makeMeasureSpec(size, BasicMeasure.EXACTLY);
                }
                currentChild.measure(iMakeMeasureSpec, MeasureSpec.makeMeasureSpec(i2, Integer.MIN_VALUE));
