...
public final class PlainListDialogAdapter extends RecyclerView.Adapter<com.afollestad.materialdialogs.internal.list.PlainListViewHolder> implements DialogAdapter<CharSequence, Function3<? super MaterialDialog, ? super Integer, ? super CharSequence, ? extends Unit>> {
    ...
    public com.afollestad.materialdialogs.internal.list.PlainListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Intrinsics.checkParameterIsNotNull(parent, "parent");
        com.afollestad.materialdialogs.internal.list.PlainListViewHolder plainListViewHolder = new com.afollestad.materialdialogs.internal.list.PlainListViewHolder(MDUtil.INSTANCE.inflate(parent, this.dialog.getWindowContext(), R.layout.md_listitem), this);
