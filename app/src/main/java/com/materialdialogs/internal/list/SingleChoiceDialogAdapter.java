...
public final class SingleChoiceDialogAdapter extends RecyclerView.Adapter<com.afollestad.materialdialogs.internal.list.SingleChoiceViewHolder> implements DialogAdapter<CharSequence, Function3<? super MaterialDialog, ? super Integer, ? super CharSequence, ? extends Unit>> {
    ...
    public /* bridge */ /* synthetic */ void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i, List list) {
        onBindViewHolder((com.afollestad.materialdialogs.internal.list.SingleChoiceViewHolder) viewHolder, i, (List<Object>) list);
    }
    ...
    public SingleChoiceDialogAdapter(MaterialDialog dialog, List<? extends CharSequence> items, int[] iArr, int i, boolean z, Function3<? super MaterialDialog, ? super Integer, ? super CharSequence, Unit> function3) {
    ...
    private final void setCurrentSelection(int i) {
        ...
        this.currentSelection = i;
        notifyItemChanged(i2, com.afollestad.materialdialogs.internal.list.UncheckPayload.INSTANCE);
        notifyItemChanged(i, com.afollestad.materialdialogs.internal.list.CheckPayload.INSTANCE);
    }
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public com.afollestad.materialdialogs.internal.list.SingleChoiceViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Intrinsics.checkParameterIsNotNull(parent, "parent");
        com.afollestad.materialdialogs.internal.list.SingleChoiceViewHolder singleChoiceViewHolder = new com.afollestad.materialdialogs.internal.list.SingleChoiceViewHolder(MDUtil.INSTANCE.inflate(parent, this.dialog.getWindowContext(), R.layout.md_listitem_singlechoice), this);
        ...
        CompoundButtonCompat.setButtonTintList(singleChoiceViewHolder.getControlView(), MDUtil.INSTANCE.createColorSelector(this.dialog.getWindowContext(), iArrResolveColors$default[1], iArrResolveColors$default[0]));
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(com.afollestad.materialdialogs.internal.list.SingleChoiceViewHolder holder, int position) {
