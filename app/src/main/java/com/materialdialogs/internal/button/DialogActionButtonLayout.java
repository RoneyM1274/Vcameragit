package com.materialdialogs.internal.button;
...
public final class DialogActionButtonLayout extends BaseSubLayout {
    ...
    protected void onFinishInflate() {
        ...
        for (int i = 0; i < length; i++) {
            ...
            dialogActionButton.setOnClickListener(new OnClickListener() { // from class: com.afollestad.materialdialogs.internal.button.DialogActionButtonLayout.onFinishInflate.1
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (ViewsKt.isVisible(appCompatCheckBox)) {
            ...
            appCompatCheckBox2.measure(MeasureSpec.makeMeasureSpec(i, Integer.MIN_VALUE), MeasureSpec.makeMeasureSpec(0, 0));
        }
        ...
        for (DialogActionButton dialogActionButton : getVisibleButtons()) {
            ...
            if (this.stackButtons) {
                dialogActionButton.measure(MeasureSpec.makeMeasureSpec(size, BasicMeasure.EXACTLY), MeasureSpec.makeMeasureSpec(this.buttonFrameSpecHeight, BasicMeasure.EXACTLY));
            } else {
                dialogActionButton.measure(MeasureSpec.makeMeasureSpec(0, 0), MeasureSpec.makeMeasureSpec(this.buttonFrameSpecHeight, BasicMeasure.EXACTLY));
            }
        }
        if ((!(getVisibleButtons().length == 0)) && !this.stackButtons) {
            ...
            if (measuredWidth >= size && !this.stackButtons) {
                ...
                for (DialogActionButton dialogActionButton3 : getVisibleButtons()) {
                    ...
                    dialogActionButton3.measure(MeasureSpec.makeMeasureSpec(size, BasicMeasure.EXACTLY), MeasureSpec.makeMeasureSpec(this.buttonFrameSpecHeight, BasicMeasure.EXACTLY));
                }
            }
        }
