...
public interface DialogBehavior {
    ViewGroup createView(Context creatingContext, Window dialogWindow, LayoutInflater layoutInflater, com.afollestad.materialdialogs.MaterialDialog dialog);
    ...
    void onPostShow(com.afollestad.materialdialogs.MaterialDialog dialog);
